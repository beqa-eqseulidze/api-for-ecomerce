...
export interface ApiMainCategoryMainCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    one_level_sub_categories: Attribute.Relation<
      'api::main-category.main-category',
      'manyToMany',
      'api::one-level-sub-category.one-level-sub-category'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiOneLevelSubCategoryOneLevelSubCategory
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    main_categories: Attribute.Relation<
      ...
      'api::main-category.main-category'
    >;
    two_level_sub_categories: Attribute.Relation<
      'api::one-level-sub-category.one-level-sub-category',
      'manyToMany',
      'api::two-level-sub-category.two-level-sub-category'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    parent: Attribute.Relation<
      ...
      'api::two-level-sub-category.two-level-sub-category'
    >;
    OnHome: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    inTopSlider: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
...
export interface ApiTwoLevelSubCategoryTwoLevelSubCategory
  extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::two-level-sub-category.two-level-sub-category': ApiTwoLevelSubCategoryTwoLevelSubCategory;
    }
  }
}
